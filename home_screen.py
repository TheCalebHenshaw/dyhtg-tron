...
# Font settings
# If you have a custom font file, load it using resource_path
# For example, if you have 'fonts/Venora-G36PO.otf'
# font_path = resource_path(os.path.join('fonts', 'Venora-G36PO.otf'))
# font = pygame.font.Font(font_path, 74)
# small_font = pygame.font.Font(font_path, 28)

# Using the default font for this example
...
# Adjust the path to the sprite sheet using resource_path
sprite_sheet_path = resource_path(os.path.join('media', 'Sprites', 'background-ezgif.com-gif-to-sprite-converter.png'))
