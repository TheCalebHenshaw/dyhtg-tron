...
# Function to correctly resolve paths to resources
def resource_path(relative_path):
    """ Get the absolute path to the resource, works for PyInstaller. """
    try:
        base_path = sys._MEIPASS  # If running as a PyInstaller package
    except Exception:
...
# Font settings
title_font = pygame.font.Font(resource_path('Venora-G36PO.otf'), 30)  # Example with a custom font
...
sprite_sheet_path = resource_path('media/Sprites/ezgif.com-gif-to-sprite-converter.png')
