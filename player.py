...
# Define a resource path function for loading files correctly
...
# Path to the spaceship images
image_path = resource_path('media/Sprites/spaceships/PNG/Spaceships/ship/')
...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y, color, controls, name, image=None) -> None:
        ...
        self.images = []
        for i in range(1, 5):
            img_path = os.path.join(image_path, f'{i}.png')
